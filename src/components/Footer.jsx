        ...
        <div className="text-right">
          <div className="w-full flex justify-end">
            <div className="w-full md:w-[350px] py-4 relative">
              ...
              <p className="text-center">Sign up for more</p>
              <p className="text-center">Cryptocoins!</p>
              <div className="py-4">
                <form>
                  ...
                  <button className="bg-button text-btnText px-5 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl md:w-auto my-2">Sign up</button>
                </form>
              </div>
