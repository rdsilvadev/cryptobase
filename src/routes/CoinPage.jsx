  ...
  return (
    <div className="rounded-div my-12 py-8">
      <div className="flex py-8">
        ...
        <div>
          <p className="text-3xl font-bold">Price {coin?.name}</p>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="flex justify-between py-4">
            ...
            <div>
              <p className="text-gray-500 text-sm">Hash algorithm</p>
              {coin.hashing_algorithm ? <p>{coin.hashing_algorithm}</p> : null}
            </div>
            <div>
              <p className="text-gray-500 text-sm">Trust Ranking</p>
          ...
          <div className="flex justify-between py-4">
            ...
            <div>
              <p className="text-gray-500 text-sm">Price change (1a)</p>
